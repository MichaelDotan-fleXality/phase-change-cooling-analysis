"""
Full-Year 2024 Potential Analysis - Smoothed Schedule Version
...
print("=" * 70)
print("Full-Year 2024 Potential Analysis - SMOOTHED SCHEDULE VERSION")
print("=" * 70)
...
report_directory = "reports/bako/full_year_2024_analysis_smoothed"
...
print("\n" + "=" * 70)
print("Full-Year 2024 Analysis Complete! (Smoothed Schedule Version)")
print("=" * 70)
