"""
48-Hour Potential Analysis (May 1-2, 2024) - Smoothed Schedule Version
Runs a full potential analysis for 48 hours around May 1-2, 2024.
...
print("=" * 70)
print("48-Hour Potential Analysis (May 1-2, 2024) - SMOOTHED SCHEDULE VERSION")
print("=" * 70)
...
# Analysis period: 48 hours (May 1-2, 2024)
...
report_directory = "reports/bako/48h_analysis_may_2024_smoothed"
...
try:
    ...
    # Filter for May 1-2, 2024 (use query to avoid KeyError)
...
try:
    ...
    print(f"   [INFO] Fetching prices from API for May 1-2, 2024...")
...
print("\n" + "=" * 70)
print("48-Hour Analysis Complete! (Smoothed Schedule Version)")
print("=" * 70)
